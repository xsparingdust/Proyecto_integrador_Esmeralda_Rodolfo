...
import backendc3.Clinica_Odontologica.entity.Domicilio;
...
public class PacienteServiceTest {
    ...
    public void guardarPaciente() {
        Paciente paciente = new Paciente("shooky", "montoya", "1223", LocalDate.of(2024, 6, 20), new Domicilio("calle falsa", 123, "robledo", "corea"), "svt@gmail.com");
